...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToysListTechView = (TextView) findViewById(R.id.tv_toy_names);

        // COMPLETED(4) Use the static ToyBox.getToyNames method and store the names in a String
        // array
        String[] toyNames = ToyBox.getToyNames();
        // COMPLETED (5) Loop through each toy and append the name to the TextView (add \n for
        // spacing)\
        for(String toyName : toyNames) {
            mToysListTechView.append(toyName + "\n\n\n");
        }
    }
}