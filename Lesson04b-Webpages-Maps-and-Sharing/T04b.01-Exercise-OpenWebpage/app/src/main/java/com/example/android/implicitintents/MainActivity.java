...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        // COMPLETED (5) Create a String that contains a URL ( make sure it starts with http:// or
        // https:// )
