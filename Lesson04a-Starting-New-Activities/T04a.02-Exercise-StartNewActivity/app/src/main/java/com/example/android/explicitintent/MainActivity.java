    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // COMPLETED (1) Store ChildActivity.class in a Class object called
                // destinationActivity
                Class destinantionActivity = ChildActivity.class;

                // COMPLETED (2) Create an Intent to start ChildActivity
                Intent intent = new Intent(context, destinantionActivity);
