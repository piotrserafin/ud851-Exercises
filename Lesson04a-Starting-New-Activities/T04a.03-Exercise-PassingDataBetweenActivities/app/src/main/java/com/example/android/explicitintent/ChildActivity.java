...
public class ChildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETED (3) Use the getIntent method to store the Intent that started this Activity
        // in a variable
        ...
        if(childIntent.hasExtra(Intent.EXTRA_TEXT)) {
            ...
            String textToShow = childIntent.getStringExtra(Intent.EXTRA_TEXT);
            mDisplayText.setText(textToShow);
        }
    }
}