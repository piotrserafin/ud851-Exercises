    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String textToShow = mNameEntry.getText().toString();
                ...
                // COMPLETED (2) Use the putExtra method to put the String from the EditText in the
                // Intent
                startChildActivityIntent.putExtra(Intent.EXTRA_TEXT, textToShow);
