...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETED (9) If the savedInstanceState bundle is not null, set the text of the URL and
    ...
    // COMPLETED (6) Using the key for the query URL, put the string in the outState Bundle
        ...
        outState.putString(SEARCH_QUERY_URL_EXTRA, urlQuery);
    ...
    // COMPLETED (8) Using the key for the raw JSON search results, put the search results into the outState Bundle
        ...
        outState.putString(SEARCH_RESULT_RAW_JSON, queryResult);
    }
}