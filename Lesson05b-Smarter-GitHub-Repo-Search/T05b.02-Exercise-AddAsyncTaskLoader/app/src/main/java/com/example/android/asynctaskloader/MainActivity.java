...
public class MainActivity extends AppCompatActivity implements LoaderManager
    ...
    // COMPLETED (2) Create a constant int to uniquely identify your loader. Call it
    ...
    // COMPLETED (16) Override onLoaderReset as it is part of the interface we implement, but don't
