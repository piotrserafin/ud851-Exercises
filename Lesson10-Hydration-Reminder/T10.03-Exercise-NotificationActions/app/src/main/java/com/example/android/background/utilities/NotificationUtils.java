...
public class NotificationUtils {
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context, WATER_REMINDER_NOTIFICATION_CHANNEL_ID)
                ...
                // COMPLETED (17) Add the two new actions using the addAction method and your
                // helper methods
    ...
    private static Action ignoreReminderAction(Context context) {
        ...
        Intent startWaterReminderIntentService =
                new Intent(context, WaterReminderIntentService.class);
        ...
        PendingIntent ignoreNotificationPendingIntent = PendingIntent.getActivity(
                context,
                ACTION_IGNORE_PENDING_INTENT_ID,
                startWaterReminderIntentService,
                PendingIntent.FLAG_UPDATE_CURRENT);

        //      COMPLETED (9) Create an Action for the user to ignore the notification (and dismiss it)
        Action  ignoreNotificationAction = new Action(R.drawable.ic_cancel_black_24px,
                "No, thanks.",
    ...
    //      COMPLETED (14) Create a PendingIntent from the intent to launch WaterReminderIntentService
        PendingIntent drinkNotificationPendingIntent = PendingIntent.getActivity(
                context,
                ACTION_DRINK_PENDING_INTENT_ID,
                startWaterReminderIntentService,
                PendingIntent.FLAG_CANCEL_CURRENT);
    //      COMPLETED (15) Create an Action for the user to tell us they've had a glass of water
        Action  drinkNotificationAction = new Action(R.drawable.ic_local_drink_black_24px,
                "I did it!",
                drinkNotificationPendingIntent);
    //      COMPLETED (16) Return the action
        return drinkNotificationAction;
    }
