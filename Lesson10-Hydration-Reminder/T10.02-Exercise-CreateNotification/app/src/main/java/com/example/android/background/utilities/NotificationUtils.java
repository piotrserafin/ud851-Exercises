...
public class NotificationUtils {
    ...
    public static final int WATER_REMINDER_NOTIFICATION_ID = 41;

    public static final int WATER_REMINDER_PENDING_INTENT_ID = 42;

    public static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "water_reminder_notification_channel";
